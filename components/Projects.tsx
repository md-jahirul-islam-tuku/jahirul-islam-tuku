    ...
    >
      <div className="max-w-7xl mx-auto px-6 text-center mb-16">
        ...
        <p className="text-slate-600 dark:text-white/70 max-w-2xl mx-auto">
          A collection of digital products I've designed and developed during my
          2 years of learning.
        </p>
      </div>
            ...
            <div className="p-8 flex-1 flex flex-col">
              ...
              <div className="flex flex-wrap gap-2 mb-8">
                {project.techStack.map((tech, tIdx) => (
                  <span
                    key={tIdx}
                    className="bg-slate-100 dark:bg-white/10 text-slate-700 dark:text-white/80 px-3 py-1 rounded-lg text-[11px] font-bold uppercase tracking-wider"
                  >
                    {tech}
                  </span>
                ))}
              ...
              <div className="flex space-x-4">
                ...
                >
                  <i className="fab fa-github mr-2"></i> Frontend
                </a>
                <a
                ...
                >
                  <i className="fab fa-github mr-2"></i> Backend
                </a>
                <a
